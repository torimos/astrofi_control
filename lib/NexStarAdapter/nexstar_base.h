...
// device IDs
#define DEV_MAIN    0x01 // Main / Interconnection Board
#define DEV_HC      0x04 // Hand Controller
#define DEV_AZ      0x10 // AZM controller on Main Board
#define DEV_ALT     0x11 // ALT controller on Main Board
#define DEV_GPS     0xb0 // GPS / Compass Interface
#define DEV_RTC     0xb2 // ???
#define DEV_APP     0x20 // CPWI/SkyPortal Application using WIFI
